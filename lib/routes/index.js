...
var _student_auth = _interopRequireDefault(require("../middleware/student_auth"));

var routes = (0, _express.Router)();
routes.post('/user/', [(0, _check.check)('email').isEmail(), (0, _check.check)('userName').isLength({
  min: 2
...
routes.post('/kittens/create/', [(0, _check.check)('kitten.name').isLength({
  min: 2
})], _kittenController["default"].addKitten);
routes["delete"]('/kittens/delete/:id', _kittenController["default"].deleteKitten); //students

routes.get('/students/', [_auth["default"], _student_auth["default"]], _studentController["default"].getAllStudents);
...
routes.post('/students/create/', [_auth["default"], (0, _check.check)('student.userName').isLength({
  min: 2
...
routes.post('/teachers/create/', [_auth["default"], (0, _check.check)('teacher.userName').isLength({
  min: 2
})], _teacherController["default"].addTeacher);
routes.put('/teachers/:id', _auth["default"], _teacherController["default"].updateTeacher);
...
routes.post('/courses/create/', [(0, _check.check)('course.name').isLength({
  min: 2
