...
var _catController = _interopRequireDefault(require("../controllers/catController"));
...
routes["delete"]('/users', _auth["default"], _userController["default"].deleteAllUsers); //kittens
...
routes["delete"]('/kittens/delete/:id', _kittenController["default"].deleteKitten); //cats

routes.get('/cats/', _catController["default"].getAllCats);
routes.get('/cats/sortby/name', _catController["default"].getAllCatsSortedByName);
routes.get('/cats/:id', _catController["default"].getSingleCat);
routes.post('/cats/create/', [(0, _expressValidator.check)('Cat.name').isLength({
  min: 2
})], _catController["default"].addCat);
routes["delete"]('/cats/delete/:id', _catController["default"].deleteCat); //students
