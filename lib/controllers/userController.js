  ...
  (0, _createClass2["default"])(userController, null, [{
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee2(req, res) {
        var match, userWithoutPassword, errors, user, token;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                _context2.next = 11;
                return _user["default"].findById(user._id).select("-password");

              case 11:
                userWithoutPassword = _context2.sent;
                _context2.next = 14;
    ...
    value: function deleteAllUsers(req, res) {
      _user["default"].deleteMany({}, function (err, result) {
        if (err) {
          return res.status(500);
        }
