...
var CourseController = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(CourseController, null, [{
    ...
    key: "addCourse",
    value: function () {
      var _addCourse = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
        var errors, c;
    ...
    value: function deleteCourse(req, res) {
      _course["default"].findOneAndRemove(req.params.id, function (err, course) {
