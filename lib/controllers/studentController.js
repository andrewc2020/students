...
function () {
  ...
  (0, _createClass2["default"])(StudentController, null, [{
    ...
    value: function getAllStudents(req, res) {
      _student["default"].find(
      /*#__PURE__*/
      function () {
        var _ref = (0, _asyncToGenerator2["default"])(
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee(err, students) {
    ...
    value: function () {
      var _getSingleStudent = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    value: function getStudentsByAge(req, res) {
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee3(err, students) {
          var sortedByAge;
    ...
    value: function getStudentsByAgeAsc(req, res) {
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee4(err, students) {
          var sortedByAge;
    ...
    value: function getStudentsByName(req, res) {
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee5(err, students) {
          var sortedByName;
    ...
    value: function updateStudent(req, res) {
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee6(err, student) {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                return _context8.abrupt("return", res.status(422));
              ...
              case 5:
                my_param = req.body.student; // info to create new student
              ...
              case 9:
                s = new _student["default"]({
                  name: req.body.student.name,
                  dob: req.body.student.dob
                });
                _context8.next = 12;
                return s.save(function (err, result) {
                  if (err) {
