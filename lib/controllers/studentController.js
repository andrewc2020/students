...
var _db_students = _interopRequireDefault(require("../dummy/db_students"));
...
function () {
  ...
  _createClass(StudentController, null, [{
    ...
    value: function getSingleStudent(req, res) {
      var findStudent = _db_students["default"].find(function (student) {
    ...
    value: function getStudentsByAge(req, res) {
      var sortedbyage = _db_students["default"].sort(function (a, b) {
    ...
    value: function getStudentsByName(req, res) {
      var sortedbyname = _db_students["default"].sort(function (a, b) {
    ...
    value: function updateStudent(req, res) {
      var student = _db_students["default"].find(function (s) {
      ...
      _db_students["default"].find(function (student) {
        return student.id === parseInt(req.params.id, 10);
    ...
    value: function deleteStudent(req, res) {
      ...
      _lodash["default"].remove(_db_students["default"], {
    ...
    value: function addStudent(req, res) {
      ...
      _db_students["default"].push({
        "id": _db_students["default"].length + 1,
        "name": req.body.data.student.name,
        "dob": req.body.data.student.dob,
        "age": calcAge
      });
